...
public class Controller {
	...
	public static final String trainfilename = "train";
	public static final String restdatafilename = "Restuarant.txt";
	...
	public static final String restWekaPrefix = "@relation \"fodors-zagat-nophone\"" + newline + newline
		+	"@attribute name NUMERIC" + newline
		+	"@attribute addr NUMERIC" + newline
		+	"@attribute city NUMERIC" + newline
		+	"@attribute type NUMERIC" + newline
	...
	public static void map(){
		...
		System.out.println("Restraunt: Single " + single.size() + " duplicate " + duplicate.size());
	}
			...
			for(int k = 0 ; k  < 1; ++k){
				...
				for(int i = 0 ; i < 20; ++i){
					...
					if(args[0].equals("random")){
						...
						WekaDecisionTree.doVoting(trf, tsf, i);
